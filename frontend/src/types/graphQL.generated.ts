...
import { ResolversContext } from '../../../backend/src/types/context'
import { SortListItemsBy } from '../../../backend/src/types/enums'
...
export const GetAllListItemsDocument = gql`
    query GetAllListItems($sortBy: SortListItemsBy, $sortDirection: SortDirection) {
        allListItems(sortBy: $sortBy, sortDirection: $sortDirection) {
            id
            name
            price
            currency
...
/**
 * __useGetAllListItemsQuery__
 *
 * To run a query within a React component, call `useGetAllListItemsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllListItemsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllListItemsQuery({
 *   variables: {
 ...
 * });
 */
export function useGetAllListItemsQuery(
    baseOptions?: Apollo.QueryHookOptions<GetAllListItemsQuery, GetAllListItemsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions }
    return Apollo.useQuery<GetAllListItemsQuery, GetAllListItemsQueryVariables>(
        GetAllListItemsDocument,
        options
    )
}
export function useGetAllListItemsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GetAllListItemsQuery, GetAllListItemsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions }
    return Apollo.useLazyQuery<GetAllListItemsQuery, GetAllListItemsQueryVariables>(
        GetAllListItemsDocument,
        options
    )
}
export type GetAllListItemsQueryHookResult = ReturnType<typeof useGetAllListItemsQuery>
export type GetAllListItemsLazyQueryHookResult = ReturnType<typeof useGetAllListItemsLazyQuery>
export type GetAllListItemsQueryResult = Apollo.QueryResult<
    GetAllListItemsQuery,
    GetAllListItemsQueryVariables
>
