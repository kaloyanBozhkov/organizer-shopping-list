...
type FormProps = {
    ...
    errorMsg?: string
    submitIconStart?: ReactElement
    submitIconEnd?: ReactElement
 ...
 * @param submitIconStart ReactElement SVG component
 * @param submitIconEnd ReactElement SVG component
    ...
    return (
        <form className={styles.form} form-id={formId} autoComplete="off" data-error={errorMsg}>
            ...
            <Button
                ...
                startIcon={!isSubmitPending && submitIconStart}
                endIcon={!isSubmitPending && submitIconEnd}
                type="submit"
                variant="contained"
